(function () {
  ...
  (function (modules) {
    ...
    return __webpack_require__(__webpack_require__.s = "Kw4x");
    /******/
  })(
  /************************************************************************/
  ...
  /******/
  {
    ...
    /***/
    function lQy(module, exports, __webpack_require__) {
    ...
    /*! exports provided: Unit, checkAddress, checkAmount, checkHash, checkIndex, checkKey, checkSeed, checkSignature, checkThreshold, checkWork, computeWork, convert, createBlock, deriveAddress, derivePublicKey, deriveSecretKey, generateSeed, hashBlock, signBlock, validateWork, verifyBlock */

    /***/
    function F0xm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "checkAddress", function () {
        return H;
      });
      /* harmony export (binding) */
      ...
      __webpack_require__.d(__webpack_exports__, "checkHash", function () {
        return d;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "checkIndex", function () {
        return D;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "checkKey", function () {
        return k;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "checkSeed", function () {
        return G;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "checkSignature", function () {
        return v;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "checkThreshold", function () {
        return y;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "checkWork", function () {
        return p;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "computeWork", function () {
        return b;
      });
      /* harmony export (binding) */
      ...
      __webpack_require__.d(__webpack_exports__, "deriveAddress", function () {
        return sA;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "derivePublicKey", function () {
        return uA;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "deriveSecretKey", function () {
        return wA;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "generateSeed", function () {
        return EA;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "hashBlock", function () {
        return GA;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "signBlock", function () {
        return yA;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "validateWork", function () {
        return Y;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "verifyBlock", function () {
        return DA;
      });
      /* harmony import */


      var fs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! fs */
      0);
      /* harmony import */
      ...
      var path__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! path */
      1);
      /* harmony import */
      ...
      var blakejs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! blakejs */
      "yPZT");
      /* harmony import */


      var blakejs__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(blakejs__WEBPACK_IMPORTED_MODULE_3__);
      /*!
      ...
      ***************************************************************************** */
      ...
      var e,
        ...
        var C,
          ...
          h ? (B = __dirname + "/", g.read = function (i, g) {
            var C = V(i);
            return C || (a || (a = fs__WEBPACK_IMPORTED_MODULE_0___default.a), Q || (Q = path__WEBPACK_IMPORTED_MODULE_1___default.a), i = Q.normalize(i), C = a.readFileSync(i)), g ? C : C.toString();
          ...
          for (r in o) {
            o.hasOwnProperty(r) && (g[r] = o[r]);
          }

          o = void 0;
          var w = {
            "f64-rem": function f64Rem(A, I) {
              return A % I;
            },
          ...
          function S(A, I, i, g) {
            ...
            return i = function (A) {
              if ("string" === I) {
                if (A) {
                  for (var i = y, g = A + void 0, C = A; i[C] && !(C >= g);) {
                    ++C;
                  }
          ...
          function _() {
            ...
            if (!(0 < b)) {
              if (g.preRun) for ("function" == typeof g.preRun && (g.preRun = [g.preRun]); g.preRun.length;) {
                K();
              }
          ...
          }, g.run = _, g.abort = $, g.preInit) for ("function" == typeof g.preInit && (g.preInit = [g.preInit]); 0 < g.preInit.length;) {
            g.preInit.pop()();
          }
      ...
      function f(A) {
        ...
        for (var I = [], i = 0; i < A.length; i += 2) {
          I.push(parseInt(A.substr(i, 2), 16));
        }
      ...
      function w(A) {
        for (var I = A.length, i = 8 * I % 5, g = 0 === i ? 0 : 5 - i, C = 0, r = "", o = 0, n = 0; n < I; n++) {
          for (C = C << 8 | A[n], o += 8; o >= 5;) {
            r += E[C >>> o + g - 5 & 31], o -= 5;
          }
        }
      ...
      function s(A) {
        for (var I = A.length, i = 5 * I % 8, g = 0 === i ? 0 : 8 - i, C = 0, r = 0, o = 0, n = new Uint8Array(Math.ceil(5 * I / 8)), t = 0; t < I; t++) {
          r = r << 5 | u(A[t]), (C += 5) >= 8 && (n[o++] = r >>> C + g - 8 & 255, C -= 8);
        }
      ...
      function c(A) {
        ...
        return function (A, I) {
          ...
          return !0;
        }(s(A.substr(I + 52)), Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2b"])(g, null, 5).reverse()) ? {
          publicKeyBytes: g,
          valid: !0
        } : i;
      }
      ...
      var l = Math.pow(2, 32) - 1,
          S = new bignumber_js__WEBPACK_IMPORTED_MODULE_2___default.a("0xffffffffffffffffffffffffffffffff");
      ...
      function U(A) {
        return "0" === A || !(!F(A) || !/^[1-9]{1}[0-9]{0,38}$/.test(A)) && new bignumber_js__WEBPACK_IMPORTED_MODULE_2___default.a(A).isLessThanOrEqualTo(S);
      }
      ...
      function Y(A) {
        ...
        var C = new bignumber_js__WEBPACK_IMPORTED_MODULE_2___default.a("0x" + g),
            t = f(A.blockHash),
            h = f(A.work).reverse(),
            e = Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bInit"])(8);
        Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bUpdate"])(e, h), Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bUpdate"])(e, t);
        var a = B(Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bFinal"])(e).reverse());
        return new bignumber_js__WEBPACK_IMPORTED_MODULE_2___default.a("0x" + a).isGreaterThanOrEqualTo(C);
      }
      ...
      function V(A) {
        for (var I, i = 1, g = 0; g < 16; g++) {
          I = A[g] + i + 65535, i = Math.floor(I / 65536), A[g] = I - 65536 * i;
        }
      ...
      function Z(A, I, i) {
        for (var g, C = ~(i - 1), r = 0; r < 16; r++) {
          g = C & (A[r] ^ I[r]), A[r] ^= g, I[r] ^= g;
        }
      }

      function q(A, I) {
        for (var i, g = x(), C = x(), r = 0; r < 16; r++) {
          C[r] = I[r];
        }
      ...
      function IA(A, I, i) {
        for (var C = new Uint8Array(i), r = 0; r < i; ++r) {
          C[r] = I[r];
        }

        var o = blakejs__WEBPACK_IMPORTED_MODULE_3___default.a.blake2b(C);
      ...
      function rA(A, I, i) {
        ...
        for (O(A[0], m), O(A[1], N), O(A[2], N), O(A[3], m), C = 255; C >= 0; --C) {
          gA(A, I, g = i[C / 8 | 0] >> (7 & C) & 1), iA(I, A), iA(A, A), gA(A, I, g);
        }
      }
      ...
      function hA(A, I) {
        ...
        for (g = 63; g >= 32; --g) {
          for (i = 0, C = g - 32, r = g - 12; C < r; ++C) {
            I[C] += i - 16 * I[g] * tA[C - (g - 32)], i = I[C] + 128 >> 8, I[C] -= 256 * i;
          }
        ...
        for (i = 0, C = 0; C < 32; C++) {
          I[C] += i - (I[31] >> 4) * tA[C], i = I[C] >> 8, I[C] &= 255;
        }
        ...
        for (g = 0; g < 32; g++) {
          I[g + 1] += I[g] >> 8, A[g] = 255 & I[g];
        }
      }

      function eA(A) {
        for (var I = new Float64Array(64), i = 0; i < 64; i++) {
          I[i] = A[i];
        }
      ...
      function aA(A) {
        var I = new Uint8Array(64),
            i = [x(), x(), x(), x()],
            C = new Uint8Array(32),
            r = blakejs__WEBPACK_IMPORTED_MODULE_3___default.a.blake2bInit(64);
        return blakejs__WEBPACK_IMPORTED_MODULE_3___default.a.blake2bUpdate(r, A), (I = blakejs__WEBPACK_IMPORTED_MODULE_3___default.a.blake2bFinal(r))[0] &= 248, I[31] &= 127, I[31] |= 64, oA(i, I), CA(C, i), C;
      }
      ...
      function BA(A, I) {
        ...
        return function (A, I, i, g) {
          ...
          for (IA(t, A.subarray(32), i + 32), eA(t), oA(e, t), CA(A, e), C = 32; C < 64; C++) {
            A[C] = a[C - 32];
          }

          for (IA(n, A, i + 64), eA(n), C = 0; C < 64; C++) {
            h[C] = 0;
          }
      ...
      function wA(A, I) {
        ...
        var C = new Uint8Array(g),
            t = Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bInit"])(32);
        return Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bUpdate"])(t, i), Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bUpdate"])(t, C), B(Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bFinal"])(t));
      }
      ...
      function sA(A, I) {
        ...
        var i = f(A),
            g = f(A),
            r = "xrb_";
        return !0 === I.useNanoPrefix && (r = "nano_"), r + w(g) + w(Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2b"])(i, null, 5).reverse());
      }
      /*!
       * nanocurrency-js: A toolkit for the Nano cryptocurrency.
       * Copyright (c) 2019 Marvin ROGER <dev at marvinroger dot fr>
      ...
      var cA = {
        ...
        MNano: 36
          ...
          lA = bignumber_js__WEBPACK_IMPORTED_MODULE_2___default.a.clone({
        EXPONENTIAL_AT: 1e9,
      ...
      function SA(A, I) {
        ...
        var o,
            n = g - C;
        if (o = "hex" === I.from ? new lA("0x" + A) : new lA(A), n < 0) for (var t = 0; t < -n; t++) {
          o = o.dividedBy(10);
      ...
      function UA(A) {
        ...
        var h = Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bInit"])(32);
        return Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bUpdate"])(h, FA), Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bUpdate"])(h, i), Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bUpdate"])(h, g), Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bUpdate"])(h, C), Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bUpdate"])(h, t), Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bUpdate"])(h, I), B(Object(blakejs__WEBPACK_IMPORTED_MODULE_3__["blake2bFinal"])(h));
      }
      ...
      function yA(A) {
        ...
        return B(function (A, I) {
          for (var i = BA(A, I), g = new Uint8Array(64), C = 0; C < g.length; C++) {
            g[C] = i[C];
          }
    ...
    "Kw4x":
    /*!**********************************!*\
      !*** ./src/assets/lib/cpupow.js ***!
      \**********************************/

    /*! no static exports found */

    /***/
    function Kw4x(module, exports, __webpack_require__) {
      var NanoCurrency = __webpack_require__(
      /*! nanocurrency */
      "F0xm"); // When the parent theard requires it, render the HTML
      ...
      self.addEventListener("message", /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(message) {
          var _message$data, blockHash, workerIndex, workerCount, workThreshold, result;

          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _message$data = message.data, blockHash = _message$data.blockHash, workerIndex = _message$data.workerIndex, workerCount = _message$data.workerCount, workThreshold = _message$data.workThreshold;
                  _context.next = 3;
                  return NanoCurrency.computeWork(blockHash, {
...
//# sourceMappingURL=07aa2b7dea0bfd4b70bc.worker.js.map